...
para.generate=function(r,p1,p2,seed=100){
  ...
  ###### Generate parameters for general factor core covariance
  ###### Argument 
  ...
  D=rgamma(p1*p2,shape=2,rate=2)
  D=covKCD(diag(D),p1,p2)$C
  
  return(list(K1=K1,K2=K2,A=A,D=D))
}
...
dat.generate=function(n,para,lambda){
  ...
  K1=para$K1; K2=para$K2; A=para$A; D=para$D
  K.root=kronecker(sym.root(K2),sym.root(K1))
  p=nrow(A)
  Sigma=K.root%*%((1-lambda)*A%*%t(A)+lambda*D)%*%t(K.root)
...
optim.iter=function(n,para,lambda,iter,seed,print.iter,eps=0.001,max.iter=100){
  ...
  C.true=(1-lambda)*A%*%t(A)+lambda*D
...
save(para.16.12.3,file="./numerical.simul_gfcore/para.16.12.3.rds")
...
save(pi.core.fit.16.12.3.24.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.24.lambda1.rds")

######### n=p/4 (48)
pi.core.fit.16.12.3.48.lambda1=optim.iter(48,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.48.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.48.lambda1.rds")  

######### n=p/2 (96)
pi.core.fit.16.12.3.96.lambda1=optim.iter(96,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.96.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.96.lambda1.rds")

######### n=p (192)
pi.core.fit.16.12.3.192.lambda1=optim.iter(192,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.192.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.192.lambda1.rds")

######### n=2p (384)
pi.core.fit.16.12.3.384.lambda1=optim.iter(384,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.384.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.384.lambda1.rds")
...
save(pi.core.fit.16.12.3.24.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.24.lambda2.rds")

######### n=p/4 (48)
pi.core.fit.16.12.3.48.lambda2=optim.iter(48,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.48.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.48.lambda2.rds")  

######### n=p/2 (96)
pi.core.fit.16.12.3.96.lambda2=optim.iter(96,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.96.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.96.lambda2.rds")

######### n=p (192)
pi.core.fit.16.12.3.192.lambda2=optim.iter(192,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.192.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.192.lambda2.rds")

######### n=2p (384)
pi.core.fit.16.12.3.384.lambda2=optim.iter(384,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.384.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.384.lambda2.rds")
...
save(pi.core.fit.16.12.3.24.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.24.lambda3.rds")

######### n=p/4 (48)
pi.core.fit.16.12.3.48.lambda3=optim.iter(48,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.48.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.48.lambda3.rds")  

######### n=p/2 (96)
pi.core.fit.16.12.3.96.lambda3=optim.iter(96,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.96.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.96.lambda3.rds")

######### n=p (192)
pi.core.fit.16.12.3.192.lambda3=optim.iter(192,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.192.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.192.lambda3.rds")

######### n=2p (384)
pi.core.fit.16.12.3.384.lambda3=optim.iter(384,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.384.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.384.lambda3.rds")
...
save(pi.core.fit.16.12.3.24.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.24.lambda4.rds")

######### n=p/4 (48)
pi.core.fit.16.12.3.48.lambda4=optim.iter(48,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.48.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.48.lambda4.rds")  

######### n=p/2 (96)
pi.core.fit.16.12.3.96.lambda4=optim.iter(96,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.96.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.96.lambda4.rds")

######### n=p (192)
pi.core.fit.16.12.3.192.lambda4=optim.iter(192,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.192.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.192.lambda4.rds")

######### n=2p (384)
pi.core.fit.16.12.3.384.lambda4=optim.iter(384,para.16.12.3,lambda,100,100,1)
save(pi.core.fit.16.12.3.384.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.3.384.lambda4.rds")

######### r=5
para.16.12.5=para.generate(5,16,12,100)
save(para.16.12.5,file="./numerical.simul_gfcore/para.16.12.5.rds")
...
save(pi.core.fit.16.12.5.24.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.24.lambda1.rds")

######### n=p/4 (48)
pi.core.fit.16.12.5.48.lambda1=optim.iter(48,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.48.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.48.lambda1.rds")  

######### n=p/2 (96)
pi.core.fit.16.12.5.96.lambda1=optim.iter(96,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.96.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.96.lambda1.rds")

######### n=p (192)
pi.core.fit.16.12.5.192.lambda1=optim.iter(192,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.192.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.192.lambda1.rds")

######### n=2p (384)
pi.core.fit.16.12.5.384.lambda1=optim.iter(384,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.384.lambda1,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.384.lambda1.rds")
...
save(pi.core.fit.16.12.5.24.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.24.lambda2.rds")

######### n=p/4 (48)
pi.core.fit.16.12.5.48.lambda2=optim.iter(48,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.48.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.48.lambda2.rds")  

######### n=p/2 (96)
pi.core.fit.16.12.5.96.lambda2=optim.iter(96,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.96.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.96.lambda2.rds")

######### n=p (192)
pi.core.fit.16.12.5.192.lambda2=optim.iter(192,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.192.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.192.lambda2.rds")

######### n=2p (384)
pi.core.fit.16.12.5.384.lambda2=optim.iter(384,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.384.lambda2,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.384.lambda2.rds")
...
save(pi.core.fit.16.12.5.24.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.24.lambda3.rds")

######### n=p/4 (48)
pi.core.fit.16.12.5.48.lambda3=optim.iter(48,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.48.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.48.lambda3.rds")  

######### n=p/2 (96)
pi.core.fit.16.12.5.96.lambda3=optim.iter(96,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.96.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.96.lambda3.rds")

######### n=p (192)
pi.core.fit.16.12.5.192.lambda3=optim.iter(192,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.192.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.192.lambda3.rds")

######### n=2p (384)
pi.core.fit.16.12.5.384.lambda3=optim.iter(384,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.384.lambda3,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.384.lambda3.rds")
...
save(pi.core.fit.16.12.5.24.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.24.lambda4.rds")

######### n=p/4 (48)
pi.core.fit.16.12.5.48.lambda4=optim.iter(48,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.48.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.48.lambda4.rds")  

######### n=p/2 (96)
pi.core.fit.16.12.5.96.lambda4=optim.iter(96,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.96.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.96.lambda4.rds")

######### n=p (192)
pi.core.fit.16.12.5.192.lambda4=optim.iter(192,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.192.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.192.lambda4.rds")

######### n=2p (384)
pi.core.fit.16.12.5.384.lambda4=optim.iter(384,para.16.12.5,lambda,100,100,1)
save(pi.core.fit.16.12.5.384.lambda4,file="./numerical.simul_gfcore/pi.core.fit.16.12.5.384.lambda4.rds")


######### (p1,p2)=(18,8)
######### r=3
para.18.8.3=para.generate(3,18,8,100)
save(para.18.8.3,file="./numerical.simul_gfcore/para.18.8.3.rds")
...
save(pi.core.fit.18.8.3.18.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.18.lambda1.rds")

######### n=p/4 (36)
pi.core.fit.18.8.3.36.lambda1=optim.iter(36,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.36.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.36.lambda1.rds")

######### n=p/2 (72)
pi.core.fit.18.8.3.72.lambda1=optim.iter(72,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.72.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.72.lambda1.rds")

######### n=p (144)
pi.core.fit.18.8.3.144.lambda1=optim.iter(144,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.144.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.144.lambda1.rds")

######### n=2p (288)
pi.core.fit.18.8.3.288.lambda1=optim.iter(288,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.288.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.288.lambda1.rds")
...
save(pi.core.fit.18.8.3.18.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.18.lambda2.rds")

######### n=p/4 (36)
pi.core.fit.18.8.3.36.lambda2=optim.iter(36,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.36.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.36.lambda2.rds")

######### n=p/2 (72)
pi.core.fit.18.8.3.72.lambda2=optim.iter(72,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.72.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.72.lambda2.rds")

######### n=p (144)
pi.core.fit.18.8.3.144.lambda2=optim.iter(144,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.144.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.144.lambda2.rds")

######### n=2p (288)
pi.core.fit.18.8.3.288.lambda2=optim.iter(288,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.288.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.288.lambda2.rds")
...
save(pi.core.fit.18.8.3.18.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.18.lambda3.rds")

######### n=p/4 (36)
pi.core.fit.18.8.3.36.lambda3=optim.iter(36,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.36.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.36.lambda3.rds")

######### n=p/2 (72)
pi.core.fit.18.8.3.72.lambda3=optim.iter(72,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.72.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.72.lambda3.rds")

######### n=p (144)
pi.core.fit.18.8.3.144.lambda3=optim.iter(144,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.144.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.144.lambda3.rds")

######### n=2p (288)
pi.core.fit.18.8.3.288.lambda3=optim.iter(288,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.288.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.288.lambda3.rds")
...
save(pi.core.fit.18.8.3.18.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.18.lambda4.rds")

######### n=p/4 (36)
pi.core.fit.18.8.3.36.lambda4=optim.iter(36,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.36.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.36.lambda4.rds")

######### n=p/2 (72)
pi.core.fit.18.8.3.72.lambda4=optim.iter(72,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.72.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.72.lambda4.rds")

######### n=p (144)
pi.core.fit.18.8.3.144.lambda4=optim.iter(144,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.144.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.144.lambda4.rds")

######### n=2p (288)
pi.core.fit.18.8.3.288.lambda4=optim.iter(288,para.18.8.3,lambda,100,100,1)
save(pi.core.fit.18.8.3.288.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.3.288.lambda4.rds")

######### r=5
para.18.8.5=para.generate(5,18,8,100)
save(para.18.8.5,file="./numerical.simul_gfcore/para.18.8.5.rds")
...
save(pi.core.fit.18.8.5.18.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.18.lambda1.rds")

######### n=p/4 (36)
pi.core.fit.18.8.5.36.lambda1=optim.iter(36,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.36.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.36.lambda1.rds")

######### n=p/2 (72)
pi.core.fit.18.8.5.72.lambda1=optim.iter(72,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.72.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.72.lambda1.rds")

######### n=p (144)
pi.core.fit.18.8.5.144.lambda1=optim.iter(144,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.144.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.144.lambda1.rds")

######### n=2p (288)
pi.core.fit.18.8.5.288.lambda1=optim.iter(288,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.288.lambda1,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.288.lambda1.rds")
...
save(pi.core.fit.18.8.5.18.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.18.lambda2.rds")

######### n=p/4 (36)
pi.core.fit.18.8.5.36.lambda2=optim.iter(36,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.36.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.36.lambda2.rds")

######### n=p/2 (72)
pi.core.fit.18.8.5.72.lambda2=optim.iter(72,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.72.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.72.lambda2.rds")

######### n=p (144)
pi.core.fit.18.8.5.144.lambda2=optim.iter(144,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.144.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.144.lambda2.rds")

######### n=2p (288)
pi.core.fit.18.8.5.288.lambda2=optim.iter(288,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.288.lambda2,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.288.lambda2.rds")
...
save(pi.core.fit.18.8.5.18.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.18.lambda3.rds")

######### n=p/4 (36)
pi.core.fit.18.8.5.36.lambda3=optim.iter(36,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.36.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.36.lambda3.rds")

######### n=p/2 (72)
pi.core.fit.18.8.5.72.lambda3=optim.iter(72,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.72.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.72.lambda3.rds")

######### n=p (144)
pi.core.fit.18.8.5.144.lambda3=optim.iter(144,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.144.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.144.lambda3.rds")

######### n=2p (288)
pi.core.fit.18.8.5.288.lambda3=optim.iter(288,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.288.lambda3,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.288.lambda3.rds")
...
save(pi.core.fit.18.8.5.18.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.18.lambda4.rds")

######### n=p/4 (36)
pi.core.fit.18.8.5.36.lambda4=optim.iter(36,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.36.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.36.lambda4.rds")

######### n=p/2 (72)
pi.core.fit.18.8.5.72.lambda4=optim.iter(72,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.72.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.72.lambda4.rds")

######### n=p (144)
pi.core.fit.18.8.5.144.lambda4=optim.iter(144,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.144.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.144.lambda4.rds")

######### n=2p (288)
pi.core.fit.18.8.5.288.lambda4=optim.iter(288,para.18.8.5,lambda,100,100,1)
save(pi.core.fit.18.8.5.288.lambda4,file="./numerical.simul_gfcore/pi.core.fit.18.8.5.288.lambda4.rds")

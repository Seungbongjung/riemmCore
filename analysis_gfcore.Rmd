...
---
  ...
  We provide the summary of the numerical simulations under general factor type core covariance model (see Section 7.1 for details). 
...
file.list=list.files(path="./numerical.simul_gfcore",pattern=".rds")
file.list=file.list[-c(1:4)]

for(i in file.list){
  load(paste("./numerical.simul_gfcore/",i,sep=""))
}
...
png("./numerical.simul_gfcore/K.16.12.3.png",width=900,height=600)
...
png("./numerical.simul_gfcore/C.16.12.3.png",width=900,height=600)
...
png("./numerical.simul_gfcore/Sigma.16.12.3.png",width=900,height=600)
...
png("./numerical.simul_gfcore/K.18.8.3.png",width=900,height=600)
...
png("./numerical.simul_gfcore/C.18.8.3.png",width=900,height=600)
...
png("./numerical.simul_gfcore/Sigma.18.8.3.png",width=900,height=600)
...
png("./numerical.simul_gfcore/K.16.12.5.png",width=900,height=600)
...
png("./numerical.simul_gfcore/C.16.12.5.png",width=900,height=600)
...
png("./numerical.simul_gfcore/Sigma.16.12.5.png",width=900,height=600)
...
png("./numerical.simul_gfcore/K.18.8.5.png",width=900,height=600)
...
png("./numerical.simul_gfcore/C.18.8.5.png",width=900,height=600)
...
png("./numerical.simul_gfcore/Sigma.18.8.5.png",width=900,height=600)
...
png("./numerical.simul_gfcore/K.rank3.png",width=900,height=600)
ggarrange(K1,K3,ncol=2,common.legend=TRUE)
dev.off()

png("./numerical.simul_gfcore/K.rank5.png",width=900,height=600)
...
png("./numerical.simul_gfcore/C.rank3.png",width=900,height=600)
ggarrange(C1,C3,ncol=2,common.legend=TRUE)
dev.off()

png("./numerical.simul_gfcore/C.rank5.png",width=900,height=600)
...
png("./numerical.simul_gfcore/Sigma.rank3.png",width=900,height=600)
ggarrange(sigma1,sigma3,ncol=2,common.legend=TRUE)
dev.off()

png("./numerical.simul_gfcore/Sigma.rank5.png",width=900,height=600)
...
library(RSpectra)
load("./numerical.simul_gfcore/para.16.12.3.rds")
load("./numerical.simul_gfcore/para.18.8.3.rds")
load("./numerical.simul_gfcore/para.16.12.5.rds")
load("./numerical.simul_gfcore/para.18.8.5.rds")

## (p1,p2,r)=(16,12,3)
A=para.16.12.3$A; D=para.16.12.3$D 

svds(0.8*A%*%t(A)+0.2*D-diag(192),1)$d/svds(0.8*A%*%t(A)+0.2*D,1)$d
svds(0.6*A%*%t(A)+0.4*D-diag(192),1)$d/svds(0.6*A%*%t(A)+0.4*D,1)$d
svds(0.4*A%*%t(A)+0.6*D-diag(192),1)$d/svds(0.4*A%*%t(A)+0.6*D,1)$d
svds(0.2*A%*%t(A)+0.8*D-diag(192),1)$d/svds(0.2*A%*%t(A)+0.8*D,1)$d

## (p1,p2,r)=(18,8,3)
A=para.18.8.3$A; D=para.18.8.3$D 

svds(0.8*A%*%t(A)+0.2*D-diag(144),1)$d/svds(0.8*A%*%t(A)+0.2*D,1)$d
svds(0.6*A%*%t(A)+0.4*D-diag(144),1)$d/svds(0.6*A%*%t(A)+0.4*D,1)$d
svds(0.4*A%*%t(A)+0.6*D-diag(144),1)$d/svds(0.4*A%*%t(A)+0.6*D,1)$d
svds(0.2*A%*%t(A)+0.8*D-diag(144),1)$d/svds(0.2*A%*%t(A)+0.8*D,1)$d

## (p1,p2,r)=(16,12,5)
A=para.16.12.5$A; D=para.16.12.5$D 
...
## (p1,p2,r)=(18,8,5)
A=para.18.8.5$A; D=para.18.8.5$D 
